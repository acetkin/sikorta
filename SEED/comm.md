...
curl -H "X-AR@�Qoken: $ARA_TOKEN" "[https://ara.spin.works/v1/projects/sikorta/comm?after=0&limit=5](https://ara.spin.works/v1/projects/sikorta/comm?after=0&limit=5)"
...
curl -X POST -H "Content-Type: application/json" -H "X-AR@�Qoken: $ARA_TOKEN" -d '{"role":"CA","content":"CA_ACK: connected and ready (project=sikorta)"}' "[https://ara.spin.works/v1/projects/sikorta/comm](https://ara.spin.works/v1/projects/sikorta/comm)"
